  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <DropdownBlock
          title="Outputting Variables with print()"
          content={
            <View>
              <Text style={[styles.dropdownContentText, { color: primaryColor }]}>
        ...
        <DropdownBlock
          title="Variable Types (Dynamic Typing)"
          content={
            <View>
              <Text style={[styles.dropdownContentText, { color: primaryColor }]}>
              ...
              <Text style={[styles.subSectionTitle, { color: primaryColor }]}>Getting the Variable Type with type():</Text>
              <Text style={[styles.dropdownContentText, { color: primaryColor }]}>
        ...
        <DropdownBlock
          title="Global vs. Local Variables (Brief Intro)"
          content={
            <View>
              <Text style={[styles.dropdownContentText, { color: primaryColor }]}>
